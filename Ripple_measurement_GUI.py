                    ...
                    if vpp_no_load!=str(0) and vrms_no_load!=str(0):
                        if vpp_full_load!=str(0) and vrms_full_load!=str(0):
                            if vpp_dynamic_load!=str(0) and vrms_dynamic_load!=str(0):
                                data = {'Sample': ['No load voltage, V:','Full load voltage, V', 'No load ripple peak to peak, V','Full load ripple peak to peak, V', 'Dynamic load ripple peak to peak, V',],'1': [vrms_no_load, vrms_full_load, vpp_no_load, vpp_full_load, vpp_dynamic_load]}
